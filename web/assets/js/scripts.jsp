<%@ page import="java.util.Date"%><%@ page import="Dao.A"%><%@ page contentType="text/javascript;charset=UTF-8" language="java" %>
...
jQuery(document).ready(function() {
  ...
  $('.f1 #f1-date').on('blur',function(){
	...
	String s;
	%>
	  date= <%=request.getParameter("f1-date")%>
	 <%
	    b=a.date(date);
	    if(!b){%>
          $('#alert').show();
